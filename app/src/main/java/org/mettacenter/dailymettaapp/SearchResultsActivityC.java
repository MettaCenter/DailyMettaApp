...
public class SearchResultsActivityC
    ...
    private static final int SEARCH_CONTEXT_CHARACTER_PADDING = 40;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] tFromColumnsSg = new String[]{ArticleTableM.COLUMN_TITLE, ArticleTableM.COLUMN_TIME, ArticleTableM.COLUMN_TEXT};
        int[] tToGuiIt = new int[]{R.id.search_row_title, R.id.search_row_date, R.id.search_row_text}; //-contained in the layout
    ...
    public Loader<Cursor> onCreateLoader(int iIdUnused, Bundle iArgumentsUnused) {
        ...
        String[] tProj = {BaseColumns._ID, ArticleTableM.COLUMN_TITLE, ArticleTableM.COLUMN_TIME, ArticleTableM.COLUMN_TEXT};
        String tSel = ArticleTableM.COLUMN_TEXT + " LIKE ?"; // COLLATE NOCASE
    ...
    private class SearchViewBinderM
        ...
        public boolean setViewValue(View iView, Cursor iCursor, int iColIndex){
            ...
            int tTimeColIndex = iCursor.getColumnIndexOrThrow(ArticleTableM.COLUMN_TIME);
            ...
            if(iColIndex == tTitleColIndex) {
                ...
                int tStart = tFirstMatchingPosition - SEARCH_CONTEXT_CHARACTER_PADDING;
                if(tStart < 0){tStart = 0;}
                int tEnd = tFirstMatchingPosition + mSearchStringSg.length() + SEARCH_CONTEXT_CHARACTER_PADDING;
                if(tEnd > tArticleTextSg.length()){tEnd = tArticleTextSg.length();}

                String tContextTextSubString = iCursor.getString(tTextColIndex).substring(tStart, tEnd);
